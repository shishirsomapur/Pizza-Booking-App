...
const TrackOrder = () => {
    ...
    return (
        <div>
            <div className='border-b-2 fixed w-full bg-white flex items-center z-50'>
            ...
            {pizzas.length > 0 ? (
                ...
                <div className='absolute w-full'>
                    <div className='bg-white flex items-center justify-center flex-col p-10 md:p-20 mt-28 m-10'>
                        <img className='md:h-52 h-51' src="src/assets/trackOrder.png" alt="No orders" />
                        <p className='text-lg md:text-2xl text-slate-400 font-bold mb-2'>No Orders to Track</p>
                        <p className='leading-3 text-slate-400 font-semibold'>Please order from the menu.</p>
                        <Link to="/menu">
                            <button className='uppercase mt-4 p-2 rounded bg-orange-400 text-white'>
                                Explore Menu
                            </button>
                        </Link>
                    </div>
