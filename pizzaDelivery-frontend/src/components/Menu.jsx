        ...
        <div className='mt-4'>
            ...
            <div className='flex justify-center mt-16 relative '>
                <div className='w-1/3 flex flex-col items-center justify-center z-10 relative'>
                    <img className="absolute opacity-15 invert" src="src/assets/foodies.avif" alt="" />
                    <h3 className='text-2xl'>Veg Pizza</h3>
                    ...
                    <Link to="/vegpizza"><button className='w-32 rounded-full border text-white bg-orange-400 hover:border-orange-400 hover:bg-white hover:text-orange-500'>View All</button></Link>
                </div>
                <div className='w-1/3 flex flex-col items-center justify-center z-10 relative '>
                    <img className="absolute  opacity-15 invert" src="src/assets/foodies.avif" alt="" />
                    ...
                    <Link to="/nonvegpizza"><button className='w-32 rounded-full border text-white bg-orange-400 hover:border-orange-400 hover:bg-white hover:text-orange-500'>View All</button></Link>
                </div>
            </div>
        </div>
    )
