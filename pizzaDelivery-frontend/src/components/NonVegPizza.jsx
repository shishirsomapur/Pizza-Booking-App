...
import { addNonVegPizza } from '../slices/pizzaSlice';
...
const NonVegPizza = () => {
    ...
    const addToCart = (pid, pname) => {
        ...
        let pizza = nonVegPizza.filter(item => { if (item.pid == pid) return item })
        dispatch(addNonVegPizza(pizza))
        console.log(orderedNonVegPizza)
    ...
    return (
        <div className='mt-3 mb-10 p-4 flex flex-col flex-wrap items-center justify-center'>
            <h1 className='text-5xl flex items-center mb-8 '>Non Veg Pizza</h1>
